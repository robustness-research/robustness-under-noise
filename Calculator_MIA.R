...
# Calculate most important attributes for each dataset, depending on technique used
for(dataset in datasets) {
  ...
  print(paste("Technique:", method))
  print("BEGIN TRAINING")
  fit = caret::train(class ~ ., data = df, method="knn", tuneGrid = expand.grid(k = 5:5), trControl = control)
  print("TRAINING SUCCESSFULL")
