...
for(dataset in datasets) {
  # Load dataset
  filename1 = paste0("../results/conf_matrices/by_dataset/", dataset, "_confusion_matrix.rds")
  #filename1 = paste0("../results/conf_matrices/by_dataset/", dataset, "_confusion_matrix_popular.rds")
