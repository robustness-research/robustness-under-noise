...
control2 = trainControl(method = "none", number = 1, preProcess = c("center", "scale")) # Control the computational nuances of the 'train' function
...
saveRDS(control2, file = "files/control2.rds")
