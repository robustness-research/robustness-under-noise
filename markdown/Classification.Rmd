...
# Print plot
print(p1)
ggsave("KLC_means.png", p1, width = 20, height = 16, dpi = 600)
```
...
for(instance in quartiles_names) {
  ...
  filtered_data <- subset(df2_q, percentage == instance & noise != 5)
...
ggsave("../results/plots/KLC_techniques_q.png", p2, width = 20, height = 16, dpi = 600)
```
...
# Print plot
print(p2)
ggsave("../results/plots/KLC_means_deciles.png", p2, width = 20, height = 16, dpi = 600)
...
# Print plot
print(p3)
ggsave("../results/plots/KLC_means_quartiles.png", p3, width = 20, height = 16, dpi = 600)
```
