...
```{r, include=FALSE}
saveRDS(deciles_df, file = "../../results/results_deciles2.rds")
#saveRDS(quartiles_df, file = "../../results/results_quartiles2.rds")
```
...
# Print plot
print(p)
ggsave("../../results/plots/KLC_plot_deciles2.png", p, width = 40, height = 40, dpi = 600)
```
...
# Print plot
print(p)
ggsave("../../results/plots/KLC_plot_quartiles2.png", p, width = 40, height = 40, dpi = 600)
```
