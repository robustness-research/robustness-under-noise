...
for(i in k_list) {
  ...
  # Create a vector of pastel colors based on the number of clusters
  pastel_colors <- c("#6EB5FF", "#B28DDF", "#E7EFAC", "#FFABAB", "#FFCCF9")
  ...
  rect.hclust(hclusters, k = i, border = pastel_colors[1:i])
  ...
  plot(sil, col = pastel_colors[1:i], main = paste("Silhouette Plot (k =", i, ")"))

  ggsave("results/plots/dendogram.png", p, width = 12, height = 10, dpi = 300)
}
```
...
cluster_colors <- c(
  "1" = "#FFABAB",  # Cluster 1: Light red/pink
  "2" = "#B28DDF",  # Cluster 2: Lavender
  "3" = "#6EB5FF",  # Cluster 3: Light blue
  "4" = "#E7EFAC"   # Cluster 4: Light green/yellow
)
...
# Save the grid plot
ggsave("results/plots/cluster_curves_grid.png", combined_grid, width = 30, height = 20, dpi = 600)
```
