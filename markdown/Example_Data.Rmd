...
ggsave("multi_x1.png", plot = multinom_plot1, width = 20, height = 20, dpi = 600)
ggsave("rf_x1.png", plot = rf_plot1, width = 20, height = 20, dpi = 600)
ggsave("svm_x1.png", plot = svm_plot1, width = 20, height = 20, dpi = 600)
...
ggsave("knn_x2.png", plot = knn_plot2, width = 20, height = 20, dpi = 600)
ggsave("multi_x2.png", plot = multinom_plot2, width = 20, height = 20, dpi = 600)
ggsave("rf_x2.png", plot = rf_plot2, width = 20, height = 20, dpi = 600)
ggsave("svm_x2.png", plot = svm_plot2, width = 20, height = 20, dpi = 600)
```
