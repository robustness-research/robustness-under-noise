...
Results (R objects) are saved under `results/instances/aggregated/tests/` as RDS files.
...
- The two saved aggregate files are:
  - `results/instances/aggregated/agg_kappa_loss_by_noise_per_fold.rds` (and .csv)
  - `results/instances/aggregated/agg_kappa_loss_by_percent_per_fold.rds` (and .csv)
- The statistical test outputs are saved under `results/instances/aggregated/tests/` as RDS and short CSV summaries.
